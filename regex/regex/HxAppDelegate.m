...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
	...
	if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPhone) {
	    self.viewController = [[[HxViewController alloc] initWithNibName:@"HxViewController_iPhone" bundle:nil] autorelease];
	} else {
	    self.viewController = [[[HxViewController alloc] initWithNibName:@"HxViewController_iPad" bundle:nil] autorelease];
	}
