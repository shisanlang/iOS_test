...
//        let documentsDirectory = docs[0] as NSString
//        let dURL = NSURL.fileURLWithPath(documentsDirectory.stringByAppendingString("localstock.plist"))
//        
//        do {
//            try NSFileManager.defaultManager().copyItemAtURL(file.fileURL, toURL: dURL)
//        } catch let error as NSError {
//            print("error")
//        }
//        let stockArray = NSArray.init(contentsOfURL: dURL);
//        
//    }
