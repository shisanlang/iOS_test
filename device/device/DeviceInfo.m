...
- (NSString *) deviceStringInfo
{
    ...
    if ([deviceString isEqualToString:@"iPhone3,2"]) return @"Verizon iPhone 4";//iPhone 4 (A1332)
    ...
    if ([deviceString isEqualToString:@"iPad2,1"])   return @"iPad 2 (A1395)";//iPad 2 (WiFi)
    if ([deviceString isEqualToString:@"iPad2,2"])   return @"iPad 2 (A1396)";//iPad 2 (GSM)
    if ([deviceString isEqualToString:@"iPad2,3"])   return @"iPad 2 (A1397)";//iPad 2 (CDMA)
